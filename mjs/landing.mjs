...
//     while (!this.conf.lang || !this.conf.viewer) {
//       console.log('while landing', !this.conf.lang, !this.conf.viewer, this.conf)
//       this.conf = JSON.parse(sessionStorage.getItem('conf'))
//       console.log('while landing', this.conf['lang'], this.conf['viewer'])
//       await waitfor(5000)
//     }
...
//     while (!accept) {
//       console.log('while accept', this.conf['lang'], this.conf['viewer'])
//       await waitfor(200)
//     }
